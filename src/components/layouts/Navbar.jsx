  ...
  return (
    <nav className="w-full fixed top-0">
      <div className="pl-4 py-3 pr-4 bg-black border-b border-gray-700 flex justify-between items-center">
        ...
        <Link to="/setting" className="flex pl-2 pr-4 py-1 gap-3 items-center rounded-3xl bg-gray-900 border border-gray-700">
          <i className="fa-solid fa-user bg-gray-700 text-xl text-blue-500 py-2 px-2.5 rounded-3xl"></i>
          <div>
