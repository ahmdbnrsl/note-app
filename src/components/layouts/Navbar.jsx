  ...
  return (
    <nav className="w-full fixed top-0">
      <div className="pl-4 py-3 pr-4 bg-black border-b border-gray-700 flex justify-between items-center">
        ...
        {username && ids ? <Link to="/setting" className="flex pl-2 pr-4 py-1 gap-3 items-center rounded-full bg-gray-900 border border-gray-700">
        ...
        </Link> : <Link className="rounded-full bg-gray-800 text-blue-500 text-lg font-medium px-5" to="/login">login</Link>}
      </div>
    </nav>
  )
}