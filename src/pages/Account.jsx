...
export default () => {
  ...
  //const userDecode = jwtDecode(user.token);
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-950 to-cyan-950 flex justify-center items-center p-5">
      <div className="w-full max-w-md">
        ...
        <div className="mt-1 w-full bg-gray-700 rounded border border-gray-700 flex justify-between overflow-hidden">
          ...
          <button className="text-teal-400 text-lg py-2 bg-gray-800 px-5"><i className="fa-regular fa-copy"></i></button>
        </div>
        ...
        <div className="mt-3 w-full flex justify-between gap-3">
          ...
          <button className="w-1/2 p-3 bg-gray-800 rounded border border-gray-700 text-lg font-medium text-red-500 hover:bg-gray-900"><i className="fa-solid fa-trash mr-2"></i>Delete Account</button>
        </div>
      </div>
    </div>
  )
